# -- Languages (SP-EN) --
  ...
  set -U g_lang_fr ' Documents et aide ' ' * Wiki:		      ' ' * Forum communautaire:	      ' ' * Chat sur Gitter:	      ' ' * Canal IRC:		      ' ' Travailler avec les packages ' ' * Rechercher les packages:   ' ' * Installer les packages:    ' ' * Mettre à jour un package:  ' ' Référentiels supplémentaires ' ' * Racine:		      ' ' * Instable:		      ' ' * X11:			      ' 'Signaler tout problème dans https://termux.com/issues ' 'Bienvenue à Termux Barracuda, Marvin!'
