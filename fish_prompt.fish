       ...
       if [ $num_items -eq 0 ]
         ...
         switch $bkup_file
           case (seq 0 (expr $num_items))
             ...
             tput cuu1
             tput ed
             read -p 'echo -n \n(set_color -b 777 6b052a)" "(set_color -b 777 000)" $b_lang[6] "["$bkup_file"]" (y/n)? "(set_color -b normal 555)" "(set_color fcfca3)' -n 1 -l argv
               switch $argv
                 case 'y'
